...
- **Usability**: The old DOM will continue to exist during the transition-away, leading to complications if the user manages to interact with that content (eg clicking buttons).
